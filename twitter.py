...
# TODO(hareesh): Some modifications made, so we can run in Google
# AppEngine.
...
import os
import rfc822
# TODO(hareesh): Not available in app engine.
...
class _FileCache(object):
  ...
  def _GetTmpCachePath(self):
    ...
    # TODO(hareesh)   return os.path.join(tempfile.gettempdir(), cache_directory)
